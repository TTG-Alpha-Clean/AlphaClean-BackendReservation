...
exports.sendPasswordResetEmail = exports.getPasswordResetEmailTemplate = exports.createEmailTransporter = void 0;
// src/config/email.ts
...
const sendPasswordResetEmail = async (to, userName, resetToken) => {
    ...
    const mailOptions = {
        ...
        html: (0, exports.getPasswordResetEmailTemplate)(userName, resetLink),
    };
    try {
